...
SECRET_KEY = '6hr+*)vma&9dqsw(p#^iafps1*aqe8=8+t%r99b4eyalr&d#rs'
...
ASGI_APPLICATION = "business.routing.application"
...
LOGIN_URL = 'authentication:login_url'
LOGIN_REDIRECT_URL = 'authentication:profile_url'
